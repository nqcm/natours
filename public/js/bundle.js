...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmF2YXNoIiwiYSI6ImNraWczNmNjcTFqbDcyeHBlbHA5enA4NnQifQ.5_cqoU7v4WUbzmdfTto0Ow';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/navash/ckig46qzk114w19pmhbw4zkwo',
    scrollZoom: false
  });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " upadted successfully"));
            }
...
var stripe = Stripe('pk_test_51I3KpNI2cruihwOQhWWbQtXziCJrIe2E626TWMlbvYeDBJV56V2gOCwWPzkEwPHoxgiD8qMftM0pgfMao3EYgzIr00NXq6J5pM');
